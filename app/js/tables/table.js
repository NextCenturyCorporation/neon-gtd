 ...
 * @param {Array} knownColumns The array of known column objects containing {String} columnName and {String} prettyName
 ...
 * @private
 */
tables.createColumns = function(knownColumns, data, ignoreColumnNames, headerElements) {
    var columns = [];
    ...
    var addColumnName = function(columnName, prettyName) {
    ...
    knownColumns.forEach(function(knownColumn) {
        addColumnName(knownColumn.columnName, knownColumn.prettyName);
    });
...
tables.Table.createSlickgridColumn_ = function(column) {
    var slickgridColumn = {};
    // Unique ID
    slickgridColumn.id = column.field ? column.field : column.name;
    // Header Text
